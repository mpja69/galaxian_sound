...
//void sound_player_hit(uint8_t);   // 0/1		6803:		Controls the "noise" explosion	HANDLE_PLAYER_HIT:
void sound_fire_enable(uint8_t); // 0/1		6805:		Controls the shoot-sound	HANDLE_PLAYER_SHOOTING_SOUND:
